...
function theme_excerpt_more( $more = '' ) {
	...
	if ( ! is_single() ) {
		$more = sprintf( '<a class="theme-read-more text-white mt-3 btn btn-info" href="%1$s">%2$s</a>',
...
function theme_pagination() {
	...
	printf( '<nav class="theme-pagination clearfix">%s</nav>', wp_kses( paginate_links( $args ), $allowed_tags ) );
}
